...
/** A gear button that opens sound, music and any extra actions the screen passes in. */
            ...
            >
              ...
              <div className="setting-list">
                <Toggle
                  label="Sound effects"
                  on={prefs.sound}
                  onChange={(sound) => setAudioPrefs({ sound })}
                />
                <Toggle
                  label="Music"
                  on={prefs.music}
                  onChange={(music) => setAudioPrefs({ music })}
                />
              </div>
              {children && <div className="setting-actions">{children}</div>}
