...
const DEFINITIONS: Record<string, Part[]> = {
  ...
  // Lirili larila: an elephant that is mostly cactus, in sandals.
  lirili: [
    body(ell(16, 44.6, 6, 2), BROWN),
    body(ell(32, 44.6, 6, 2), BROWN),
    stroke('M13 44.5L19 44.5M29 44.5L35 44.5', DARK_BROWN, 1),
    body(rrect(5, 22, 6, 12, 3), GREEN),
    body(rrect(12, 18, 24, 26, 9), GREEN),
    stroke('M18 24L18 40M24 22L24 42M30 24L30 40', '#1a7a36', 1),
    stroke('M16 28L14 27M20 34L22 33M28 27L26 26M32 36L34 35M7 26L5 25M22 39L20 40', INK, 0.9),
    body(blob([7, 12], [11, 5], [17, 7], [17, 17], [11, 19]), GREY),
    body(blob(...mirror([[7, 12], [11, 5], [17, 7], [17, 17], [11, 19]])), GREY),
    body(ell(24, 13, 8, 7.5), GREY),
    ...cord('M24 16Q23 24 28 26', GREY, 3),
    ...dots(20.5, 27.5, 11.5, 1),
  ],
  // Trippi troppi: a shrimp with a cat's face.
  trippi: [
    stroke('M12 40L11 44M17 41L17 45M22 40L23 44', INK, 1.4),
    body(poly([4, 37], [10, 34], [10, 44]), ORANGE),
    body(blob([9, 38], [8, 30], [13, 24], [22, 22], [29, 25], [29, 34], [22, 40], [14, 41]), ORANGE),
    stroke('M14 25Q12 32 15 40M20 23Q18 31 21 39M25 24Q24 30 26 36', '#c85a14', 1.1),
    stroke('M30 14Q22 4 12 3M34 13Q30 5 21 2', INK, 1),
    body(poly([27, 15], [28, 7], [32.5, 12]), GREY),
    body(poly([43, 15], [42, 7], [37.5, 12]), GREY),
    body(ell(35, 20, 9, 8), GREY),
    stroke('M31 13L31 16M35 12L35 15M39 13L39 16', DARK_GREY, 1.1),
    paint(ell(31.5, 19, 2.3, 2.3), WHITE),
    paint(ell(38.5, 19, 2.3, 2.3), WHITE),
    ...dots(31.5, 38.5, 19, 0.9),
    paint(ell(35, 23, 1.2, 0.9), PINK),
    stroke('M27 23L31 24M27 26L31 25M39 24L43 23M39 25L43 26', INK, 0.7),
  ],
  // Honk: a goose. Peace was never an option.
  honk: [
    stroke('M18 40L17 44M26 40L27 44', ORANGE, 1.8),
    body(ell(16, 45, 3.2, 1.4), ORANGE),
    body(ell(28, 45, 3.2, 1.4), ORANGE),
    body(blob([5, 30], [11, 25], [24, 25], [33, 30], [31, 39], [20, 42], [9, 39]), WHITE),
    stroke('M11 32Q18 29 25 33', DARK_GREY, 1.2),
    body(rrect(27, 13, 7, 20, 3.5), WHITE),
    body(ell(32, 11, 6.5, 5.5), WHITE),
    body(poly([37, 8.5], [45.5, 9.5], [37.5, 12]), ORANGE),
    body(poly([37.5, 13], [44.5, 17], [37, 15]), ORANGE),
    paint(ell(33, 9.5, 1.1, 1.1), INK),
    stroke('M30 6.5L35 8', INK, 1.4),
    stroke('M42 4L44.5 2M44.5 6.5L46.5 5.5', INK, 1),
  ],
  // Boneca ambalabu: a frog on a tyre, on human legs.
  boneca: [
    ...cord('M19 36L18 42.5M29 36L30 42.5', SKIN, 2.4),
    body(rrect(13, 42, 7, 3.2, 1.5), RED),
    body(rrect(28, 42, 7, 3.2, 1.5), RED),
    body(ell(24, 30, 14, 8.5), DARK_GREY),
    paint(ell(24, 30, 6.5, 3.8), GREY),
    stroke('M12 27L14 29M12 33L14 31M36 27L34 29M36 33L34 31M18 22.5L19 24.5M30 22.5L29 24.5M18 37.5L19 35.5M30 37.5L29 35.5', INK, 1),
    body(ell(24, 16, 11, 7.5), GREEN),
    ...stare(18.5, 29.5, 9.5, 3.4, 0),
    stroke('M16 19Q24 23 32 19', INK, 1.3),
    paint(ell(21, 15, 0.6, 0.5), INK),
    paint(ell(27, 15, 0.6, 0.5), INK),
  ],
};
