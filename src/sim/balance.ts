...
export const UNITS: readonly UnitDef[] = [
  {
    id: 'sparkmouse', name: 'Pip', cost: 1, origin: 'voltage', role: 'striker',
  ...
  {
    id: 'chromeshell', name: 'Bo', cost: 1, origin: 'chrome', role: 'bruiser',
  ...
  {
    id: 'glitchtoad', name: 'Zed', cost: 1, origin: 'glitch', role: 'caster',
  ...
  {
    id: 'voltmoth', name: 'Mina', cost: 1, origin: 'voltage', role: 'caster',
  ...
  {
    id: 'bytebat', name: 'Vex', cost: 2, origin: 'glitch', role: 'striker',
  ...
  {
    id: 'ironhog', name: 'Otto', cost: 2, origin: 'chrome', role: 'bruiser',
  ...
  {
    id: 'surgeeel', name: 'Eli', cost: 2, origin: 'voltage', role: 'bruiser',
  ...
  {
    id: 'mirrorowl', name: 'Nora', cost: 2, origin: 'chrome', role: 'caster',
  ...
  {
    id: 'staticfox', name: 'Ash', cost: 3, origin: 'glitch', role: 'striker',
  ...
  {
    id: 'chromemantis', name: 'Kai', cost: 3, origin: 'chrome', role: 'striker',
  ...
  {
    id: 'thunderstag', name: 'Rex', cost: 4, origin: 'voltage', role: 'bruiser',
  ...
  {
    id: 'nullserpent', name: 'Nyx', cost: 5, origin: 'glitch', role: 'caster',
  ...
  {
    id: 'sporecat', name: 'Tia', cost: 1, origin: 'toxin', role: 'support',
  ...
  {
    id: 'prismfly', name: 'Lu', cost: 1, origin: 'prism', role: 'support',
  ...
  {
    id: 'acidfrog', name: 'Gus', cost: 2, origin: 'toxin', role: 'striker',
  ...
  {
    id: 'lumihare', name: 'Ivy', cost: 2, origin: 'prism', role: 'support',
  ...
  {
    id: 'blightmoth', name: 'Jin', cost: 3, origin: 'toxin', role: 'caster',
  ...
  {
    id: 'beamray', name: 'Remy', cost: 3, origin: 'prism', role: 'support',
  ...
  {
    id: 'sludgebear', name: 'Hank', cost: 4, origin: 'toxin', role: 'bruiser',
  ...
  {
    id: 'solaris', name: 'Sol', cost: 5, origin: 'prism', role: 'support',
